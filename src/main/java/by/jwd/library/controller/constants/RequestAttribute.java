...
public class RequestAttribute {
    ...
    public final static String DELIVERY_RESERVATIONS = "deliveryTypes";
    public final static String DELIVERY_MSG = "deliveryMsg";
    public final static String EDIT_USER_INFO_MSG = "userInfoEditMSG";
