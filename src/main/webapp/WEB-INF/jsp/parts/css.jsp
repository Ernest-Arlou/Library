...
<!-- Mobile Menu -->
<link href="${pageContext.request.contextPath}/resources/css/mmenu.css" rel="stylesheet" type="text/css"/>
<link href="${pageContext.request.contextPath}/resources/css/mmenu.positioning.css" rel="stylesheet" type="text/css"/>
