...
<%--    <c:out value="${sessionScope.local}" />--%>
    ...
    <script>
        function validate() {
            let username = document.login_form.login; //get form name "LoginForm" and textbox name "txt_username" store in variable username
            let password = document.login_form.password; //get form name "LoginForm" and textbox name "txt_password" store in variable password
...
<div style="text-align: center;">
    ...
    <a href="registration1.jsp"> Registration</a>

    <form method="get" action="Controller">
        <input type="hidden" name="command" value="page">
        <input type="hidden" name="page" value="1">
        <input type="submit" name="log_button" value="Media">
    </form>
