                                                ...
                                                <c:choose>
                                                    <c:when test="${sessionScope.role.equalsIgnoreCase('user')}">
                                                       <c:if test="${mediaDetail.availableCopies > 0}">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/Controller?command=reserve&mediaId=${mediaDetail.mediaID}&lastCommand=${requestScope.lastCommand}&lastPage=${lastPage}" class="btn btn-dark-gray">${hold}</a>
                                                        </c:if>
                                                       </c:if>
                                                    </c:when>
                                                    <c:otherwise>
